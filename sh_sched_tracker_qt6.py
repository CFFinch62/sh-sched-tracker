...
from PyQt6.QtCore import QTimer, Qt, QTime, QSettings, QPoint, QSize
...
class ScheduleWindow(QMainWindow):
    def __init__(self, enable_test_mode=False):
        ...
        self.setWindowFlags(Qt.WindowType.WindowStaysOnTopHint | Qt.WindowType.MSWindowsFixedSizeDialogHint)
        ...
        self.admin_password = self.settings.value('admin_password', 'chucksoft')
    ...
    def setup_ui(self):
        ...
        schedule_container.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        ...
        regular_container.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        ...
        regular_title.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        regular_title.setAlignment(Qt.AlignmentFlag.AlignLeft)  # Left align title
        
        self.regular_label = QLabel("Not in session")
        self.regular_label.setObjectName("regular_label")
        self.regular_label.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        self.regular_label.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
        ...
        delay_container.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        ...
        delay_title.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        delay_title.setAlignment(Qt.AlignmentFlag.AlignLeft)  # Left align title
        
        self.delay_label = QLabel("Not in session")
        self.delay_label.setObjectName("delay_label")
        self.delay_label.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        self.delay_label.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
        ...
        homeroom_container.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        ...
        homeroom_title.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        homeroom_title.setAlignment(Qt.AlignmentFlag.AlignLeft)  # Left align title
        
        self.homeroom_label = QLabel("Not in session")
        self.homeroom_label.setObjectName("homeroom_label")
        self.homeroom_label.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        self.homeroom_label.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
    ...
    def create_menu_bar(self):
        ...
        # Create all menu items (except Exit) in alphabetical order
        menu_items = [
            ('Change Admin Password', self.change_password),
            ('Color Settings', self.show_color_settings),
            ('Enable Test Mode', None),  # Special handling for test mode
            ('Schedule Editor', self.show_schedule_editor),
            ('Select Tray Icon', None),  # Special handling for submenu
        ]
        
        # Add menu items in alphabetical order
        for item_text, handler in menu_items:
            if item_text == 'Enable Test Mode':
                # Special handling for test mode
                self.test_mode_action = QAction(item_text, self)
            ...
            elif item_text == 'Select Tray Icon':
    ...
    def setup_test_controls(self):
        if self.test_container is None:
            ...
            self.test_container.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
    ...
    def change_password(self):
        ...
        current_pwd_dialog.setTextEchoMode(QLineEdit.EchoMode.Password)
        ...
        new_pwd_dialog.setTextEchoMode(QLineEdit.EchoMode.Password)
        ...
        confirm_pwd_dialog.setTextEchoMode(QLineEdit.EchoMode.Password)
